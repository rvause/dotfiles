...
"
" HTML
autocmd FileType html,xhtml,xml,css,scss,mobi,jinja setlocal expandtab shiftwidth=4 tabstop=8 softtabstop=4 wrap
...
fun! <SID>StripTrailingWhitespaces()
    ...
    call cursor(l, c)
endfun
autocmd FileType c,cpp,java,php,ruby,python,javascript,css,scss,html autocmd BufWritePre <buffer> :call <SID>StripTrailingWhitespaces()
